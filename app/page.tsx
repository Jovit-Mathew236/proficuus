          ...
          <div className="max-w-2xl py-32 sm:py-48 lg:py-56">
            ...
            <div className="text-left">
              ...
              <p className="mt-8 text-pretty text-lg font-medium text-gray-500 sm:text-xl/8">
                Jesus Youth Medical Engineering Students Team is a stream team
                under the Kerala campus ministry that addresses medical
                engineering campuses. The main programs initiated by the MEST
                team are Proficuus, Footprints, Discovery, Insight and Catalyst
              </p>
